...
const GestureSystem = {
  ...
  onHandUpdate: null,   // (leftHand, rightHand) => {} — fires every processed frame
  ...
  _processResults(results) {
    ...
    // Fire per-frame callback for single-hand detection
    if (this.onHandUpdate) {
      this.onHandUpdate(this.leftHand, this.rightHand);
    }
  },
